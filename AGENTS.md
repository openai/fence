...
- `script/test-protected-run`
  ...
  - Runs `standard` to prove container paths are disabled and `unsafe-preserve` to prove container paths remain usable while the report denies ordinary containment assurance.
