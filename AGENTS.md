...
- `script/test-profile-candidate`
  ...
  - The candidate is intentionally broader than a final status-only profile: it permits eight fixed GitHub web/API, Actions control-service, and results-storage HTTPS destinations and reports that later workflow code can use them for egress.
