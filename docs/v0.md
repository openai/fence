...
state, and netlink sockets; ordinary unit tests still cover deterministic
normalization and packet-prefix reduction helpers, and the privileged workflow
is the required behavioral proof.
