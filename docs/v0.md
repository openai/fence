...
of these paths selects a platform profile or proves host-network blocking
finalization. This evidence is not reachable from the public CLI. A distinct packaged-artifact acceptance
